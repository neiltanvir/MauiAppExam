...
public partial class EmployeesPage : ContentPage
{
    ...
    private void LoadEmployees()
    {
        ...
        try
        {
            ...
            {
                BaseAddress = new Uri(DeviceInfo.Platform == DevicePlatform.Android ? "http://10.0.2.2:5008" : "http://localhost:5008")
            };
    ...
    private async void EmployeeMenuItem_Clicked(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            client.BaseAddress = new Uri(DeviceInfo.Platform == DevicePlatform.Android ? "http://10.0.2.2:5008" : "http://localhost:5008");
